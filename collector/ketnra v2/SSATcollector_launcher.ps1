...
Write-Host "Kentra V2 launcher package: $scriptDir" -ForegroundColor Cyan
...
Write-Host "Kentra V2 collector engine: $collector" -ForegroundColor Cyan
...
if ($costoptimization) { $passArgs.costoptimization = $true }
